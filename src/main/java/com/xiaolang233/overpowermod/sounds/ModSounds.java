package com.xiaolang233.overpowermod.sounds;
...
public class ModSounds {
    ...
    public static final BlockSoundGroup BLOCK_SOUND_GROUP = new BlockSoundGroup(1f,1f,
            ModSounds.BLOCK_BREAK,ModSounds.BLOCK_STEP,ModSounds.BLOCK_PLACE,ModSounds.BLOCK_HIT,
            ModSounds.BLOCK_FALL); //有顺序
    public static SoundEvent registerSoundEvents(String name){
        Identifier identifier = new Identifier(Overpowermod.MOD_ID,name);
